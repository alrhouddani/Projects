...
function Show-project_psf {
	...
	$buttonCheck_Click={
		...
		$session =  Get-WmiObject -Class Win32_Product -ComputerName ($textbox1.Text) | select-object name, Version, Caption
	...
	$formAssetActiveSessionTo.Text = 'Find Installed Software'
